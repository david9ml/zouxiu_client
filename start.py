...
print(zouxiu_client.product(data={"productId": "0000000".encode("utf-8"),
                                  "productName": "test0000000".encode("utf-8"),
                                  "brandNameZhs": "Prada".encode("utf-8"),
                                  "productDesc": "Prada".encode("utf-8"),
                                  "catName": "fengyi".encode("utf-8")}))
